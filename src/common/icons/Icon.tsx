...
export const ArchiveBoxXMarkIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.03 1.125 0 1.131.094 1.976 1.057 1.976 2.192V7.5M8.25 7.5h7.5M8.25 7.5v9a1.5 1.5 0 001.5 1.5h4.5a1.5 1.5 0 001.5-1.5v-9M8.25 7.5h7.5M15 12l-3 3m0 0l-3-3m3 3V9" />
    </svg>
);

export const DocumentPlusIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
// Default export helper: agrupa los iconos para permitir `import Icon from '.../icons/Icon'` y uso como `Icon.Upload`.
const Icon: Record<string, React.FC<IconProps>> = {
    Upload: UploadIcon,
